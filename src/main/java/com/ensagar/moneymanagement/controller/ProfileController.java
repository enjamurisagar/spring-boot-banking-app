...
import com.ensagar.moneymanagement.service.ProfileService;
...
public class ProfileController {
	...
	public ResponseEntity<ProfileDTO> registerProfile(@RequestBody ProfileDTO request){
	...
	public ResponseEntity<Map<String, Object>> login(@RequestBody AuthDTO authDTO) {
		...
		try {
			if(authDTO != null && !profileService.isProfileActivated(authDTO.getEmail())) {
